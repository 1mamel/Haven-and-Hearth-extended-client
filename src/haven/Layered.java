...
public class Layered extends Drawable {
    ...
    boolean loading;
    static final LayerCache cache = new LayerCache(1000);
    final Map<Layer, Sprite.Part> pcache = new WeakHashMap<Layer, Sprite.Part>();
    ...
    public static class LayerCache {
        private final int cachesz;
        private final Map<Object[], Layer> cache = new IdentityHashMap<Object[], Layer>();
