...
public class RichTextBox extends Widget {
    ...
    public RichTextBox(Coord c, Coord sz, Widget parent, String text, RichText.Foundry fnd) {
        super(c, sz, parent);
        this.fnd = fnd;
        this.text = fnd.render(text, sz.getX() - 20);
        this.sb = new Scrollbar(new Coord(sz.getX(), 0), sz.getY(), this, 0, this.text.sz().getY() + 20 - sz.getY());
    }
    ...
    public void settext(String text) {
        this.text = fnd.render(text, sz.getX() - 20);
        sb.max = this.text.sz().getY() + 20 - sz.getY();
        sb.val = 0;
    }

    public void setsz(Coord s) {
        sz = s;
        sb.c = new Coord(sz.getX() - 10, 0);
        sb.sz = new Coord(10, sz.getY());
        settext(text.text);
    }
