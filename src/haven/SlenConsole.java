...
public class SlenConsole extends ChatHW implements IRCConnectionListener {
    ...
    public String user;
    public final SlenHud parent;
    private static SlenChat tSCWnd;
    @SuppressWarnings({"FieldCanBeLocal", "UnusedDeclaration"})
    private boolean initialized = false;
    public final List<SlenChat> wndList = new ArrayList<SlenChat>();
    ...
    public SlenConsole(SlenHud parent) {
        ...
        if (CustomConfig.ircServerAddress.length() != 0 && CustomConfig.isIRCOn) {
        ...
        if (input.charAt(0) == '/') {
            ...
            if (cmd.equals("/JOIN") && IRC != null) {
                ...
                if (cArgs.length >= 3) {
                    ...
                    src.out.append(user + ": " + msg.toString(), Color.DARK_GRAY);
                } else {
                ...
                if (cArgs.length >= 3) {
                    ...
                    tSCWnd.out.append(user + ": " + msg.toString());
                } else {
                ...
                if (cArgs.length >= 2) {
                    ...
                    src.out.append('*' + user + ' ' + msg.toString() + '*', Color.MAGENTA.darker());
                } else {
