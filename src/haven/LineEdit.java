...
public class LineEdit {
    ...
    public final KeyHandler mode;

    public abstract static class KeyHandler {
    ...
    public class EmacsMode extends KeyHandler {
        ...
        private String last = "";
        private final List<String> yanklist = new ArrayList<String>();
        private final List<UndoState> undolist = new ArrayList<UndoState>();
