...
public class Homing extends Moving {
    ...
    public Homing(final Gob gob, final int tgt, final Coord tc, final int v) {
        super(gob);
        this.tgt = tgt;
        this.tc = tc;
        this.v = v;
    ...
    public Coord getc() {
        ...
        if (tgt != null)
            tc = tgt.rc;
        final Coord d = tc.sub(gob.rc);
        final double e = gob.rc.dist(tc);
    ...
    public void ctick(final int dt) {
        final double da = ((double) dt / 1000) / 0.06;
