...
public class Session {
    ...
    int ackseq;
    long acktime = -1;
    final LinkedList<Message> uimsgs = new LinkedList<Message>();
    final Map<Integer, Message> waiting = new TreeMap<Integer, Message>();
    final LinkedList<Message> pending = new LinkedList<Message>();
    final Map<Integer, ObjAck> objacks = new TreeMap<Integer, ObjAck>();
    String username;
    byte[] cookie;
